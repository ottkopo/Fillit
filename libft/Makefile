...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/10/21 12:01:39 by okoponen          #+#    #+#              #
#    Updated: 2019/11/13 16:11:58 by okoponen         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
./ft_strstr.c ./ft_tolower.c ./ft_toupper.c ./ft_strrchr.c ./ft_memalloc.c \
...
./ft_strrev.c ./ft_swap.c ./ft_putchar.c ./ft_putstr.c ./ft_putendl.c \
./ft_putnbr.c ./ft_putchar_fd.c ./ft_putstr_fd.c ./ft_putendl_fd.c \
./ft_putnbr_fd.c ./ft_isupper.c ./ft_islower.c ./ft_lstnew.c \
./ft_lstdelone.c ./ft_iswhitespace.c
OBJECT = ./ft_atoi.o ./ft_bzero.o ./ft_isalnum.o ./ft_isalpha.o \
./ft_isascii.o ./ft_isdigit.o ./ft_isprint.o ./ft_memccpy.o ./ft_memchr.o \
./ft_memcmp.o ./ft_memcpy.o ./ft_memmove.o ./ft_memset.o ./ft_strcat.o \
...
./ft_strstr.o ./ft_tolower.o ./ft_toupper.o ./ft_strrchr.o ./ft_memalloc.o \
...
./ft_strrev.o ./ft_swap.o ./ft_putchar.o ./ft_putstr.o ./ft_putendl.o \
./ft_putnbr.o ./ft_putchar_fd.o ./ft_putstr_fd.o ./ft_putendl_fd.o \
./ft_putnbr_fd.o ./ft_isupper.o ./ft_islower.o ./ft_lstnew.o \
./ft_lstdelone.o ./ft_iswhitespace.o
